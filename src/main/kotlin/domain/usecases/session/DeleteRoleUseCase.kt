 ...
 * @since 1.0
 */
class DeleteRoleUseCase @Inject constructor(private val userRepository: UserRepository) {
     ...
     */
    suspend fun execute(id: String): Boolean = userRepository.deleteRole(ObjectId(id))
}
